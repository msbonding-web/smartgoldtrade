<?php
session_start();
require_once '../header.php'; // Adjust path as necessary
...
// NOTE: The form submission logic for initiating a trade will be added in the next step.
...
<div class="trade-details-container">
    ...
    <a href="p2p_offers.php" class="btn btn-secondary mb-3" style="margin-bottom: 20px; display: inline-block;">← Back to Offers</a>
    ...
    <?php if ($offer_details): ?>
        <div class="trade-details-grid">
            ...
            <div class="p2p-card">
                ...
                <form action="initiate_trade.php" method="POST">
